...
public class PrivatePersonWithSign {
    ...
    public com.example.demo.smdo.entity.SignDate getSignDate() {
        return SignDate;
    }

    public void setSignDate(com.example.demo.smdo.entity.SignDate signDate) {
        SignDate = signDate;
    }
}
