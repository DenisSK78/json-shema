...
public class Organization {
    ...
    //Document 0-n
    //TaskList 0-1
    private List<OfficialPerson> OfficialPerson;
    ...
    public List<com.example.demo.smdo.entity.OfficialPerson> getOfficialPerson() {
        return OfficialPerson;
    }

    public void setOfficialPerson(List<com.example.demo.smdo.entity.OfficialPerson> officialPerson) {
        OfficialPerson = officialPerson;
    }
}
